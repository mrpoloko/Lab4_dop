...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Suspenders suspenders = christopherRobin.takeOffShirt("Blue", Quality.Good);
        piglet.justifyExpectation(suspenders);

        Shirt shirt = new Shirt(0.5, christopherRobin, iaia, vinni, piglet);
